...
from script.utils.synset_utils import _display_synsets
...
# templates 6: entitle(verb, sb/sth, title)
synsets["entitle"] = "entitle.v.02"
# definition: give a title to

# templates 7: publish(verb, author, publication, publisher/media, at-time, at-location)
synsets["publish"] = "publish.v.03"
# definition: have (one's written work) issued for publication

# templates 8: influence(verb, influencer, affected, effect, degree/range)
synsets["influence"] = "influence.v.01"
# definition: have and exert influence or effect

# templates 9: give/gain(verb, giver, gainer, item, currency, quantity, at-time, at-location)

# templates 10: study(verb, sb, subject, at-time, at-loc)
synsets["study"] = "learn.v.04"
# definition: be a student of a certain subject

# templates 11: visit(verb, sb, to-loc, time?)
synsets["visit"] = "visit.v.01"
# definition: go to see a place, as for entertainment

# templates 12: be_born(verb, sb, at-time, at-place)
synsets["be_born"] = "be_born.v.01"
# definition: come into existence through birth

# templates 13: die/pass away(verb, sb, at-time, at-place, cause)
